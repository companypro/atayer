...
class CustomTextFieldCountry extends StatefulWidget {
  final String titleText;
  final String hintText;
  final TextEditingController? controller;
  final FocusNode? focusNode;
  ...
  final bool isEnabled;
  final int maxLines;
  final TextInputAction inputAction;  final TextCapitalization capitalization;
  final String? prefixImage;
  final IconData? prefixIcon;
  ...
  @override
  CustomTextFieldCountryState createState() => CustomTextFieldCountryState();
}

class CustomTextFieldCountryState extends State<CustomTextFieldCountry> {
  bool _obscureText = true;
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            textAlign: widget.textAlign,
            style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
            textInputAction: widget.inputType == TextInputType.phone
            ...
            autofocus: false,
            obscureText: widget.isPassword ? _obscureText : false,
            textDirection: TextDirection.ltr, // Add this line for RTL support
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: widget.isPhone ? SizedBox(width:90, child: Row(children: [
