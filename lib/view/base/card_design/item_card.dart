...
class ItemCard extends StatelessWidget {
  ...
  final int index;
  const ItemCard({Key? key, required this.item, this.isPopularItem = false, required this.isFood, required this.isShop, this.isPopularItemCart = false, required this.index}) : super(key: key);
              ...
              children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    ...
                    child: Stack(children: [
                      Padding(
                        padding: EdgeInsets.only(top:  Dimensions.paddingSizeSmall , left: Dimensions.paddingSizeExtraLarge , right:  Dimensions.paddingSizeExtraLarge ),
                        child: ClipRRect(
                      ...
                      // Padding(
                      //   padding: EdgeInsets.only(top: isPopularItem ? Dimensions.paddingSizeSmall : 0, left: isPopularItem ? Dimensions.paddingSizeLarge : 0, right: isPopularItem ? Dimensions.paddingSizeLarge : 0),
                      //   child: ClipRRect(
                      //     borderRadius: BorderRadius.only(
                      //       topLeft: const Radius.circular(Dimensions.radiusLarge),
                      //       topRight: const Radius.circular(Dimensions.radiusLarge),
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Stack(clipBehavior: Clip.none, children: [
                        ...
                        Column(
                          crossAxisAlignment: isPopularItem ? CrossAxisAlignment.start : CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          //   Text("(${item.ratingCount})", style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                          //
                          // ]) : (Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! && item.unitType != null) ? Text('(${ item.unitType ?? ''})',
...
class ItemCardHome extends StatelessWidget {
  ...
  final bool isShop;
  final bool isPopularItemCart;
  const ItemCardHome({Key? key, required this.item, this.isPopularItem = false, required this.isFood, required this.isShop, this.isPopularItemCart = false}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    double? discount = item!.discount == 0 ? item!.discount!.toDouble() : item!.discount!.toDouble();
    String? discountType = item!.discount == 0 ? item!.discountType : 'percent';
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Expanded(
                  ...
                  child: Stack(children: [
                    ...
                    // Get.find<ItemController>().isAvailableHome(item!) ? const SizedBox() : NotAvailableWidget(radius: Dimensions.radiusLarge, isAllSideRound: isPopularItem),
