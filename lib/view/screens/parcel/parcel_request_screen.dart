...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
  ...
  void initCall(){
    ...
    print('=====lll===> ${widget.pickedUpAddress.zoneId}');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: guestCheckoutPermission || _isLoggedIn ? GetBuilder<OrderController>(builder: (orderController) {
              ...
              return Column(children: [
                ...
                Expanded(child: SingleChildScrollView(
                  ...
                  child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              onTap: () {
                                !ResponsiveHelper.isDesktop(context) ? Get.bottomSheet(
                                  ...
                                  return const Dialog(
                                    ...
                                    child: DeliveryInstructionBottomSheet(),
                                  );
                                  },
                                );
                              },
                    ...
                    orderController.offlineMethodList != null && parcelController.payerIndex == 0 ? OfflinePaymentButton(
      ...
      onPressed: parcelController.acceptTerms ? () {
        if(parcelController.distance == -1) {
          ...
          PlaceOrderBody placeOrderBody = PlaceOrderBody(
            ...
            partialPayment: 0, guestId: Get.find<AuthController>().isGuestLoggedIn() ? int.parse(Get.find<AuthController>().getGuestId()) : 0, isBuyNow: 0, guestEmail: null,
          );
