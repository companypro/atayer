      ...
      child: Column(
        ...
        Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('the_address'.tr, style: robotoBold.copyWith(fontSize: 18)),
                  TextButton(onPressed: () =>Get.find<LocationController>().navigateToLocationScreen('home'),
                      child: Row(
                        children: [
                          Image(image: AssetImage(Images.addressicon),width: 18,),
                          SizedBox(width: 8,),
                          Text('the_home'.tr, style: robotoBold.copyWith(fontSize: 18)),
