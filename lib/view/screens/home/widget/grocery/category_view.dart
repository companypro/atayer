...
class CategoryView extends StatelessWidget {
  const CategoryView({Key? key, this.page}) : super(key: key);
  final int? page;
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SplashController>(builder: (splashController) {
      // bool isPharmacy = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.grocery;
      // bool isFood = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.grocery;
          ...
          children: [
            ...
            categoryController.categoryList != null ? GridView.builder(
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                crossAxisSpacing: Dimensions.paddingSizeExtraSmall, childAspectRatio: (1/1),
              ),
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeSmall, top: Dimensions.paddingSizeDefault,left: Dimensions.paddingSizeSmall,),
                  child: InkWell(
                    onTap: () => Get.toNamed(RouteHelper.getCategoryItemRoute(
                      categoryController.categoryList![index].id, categoryController.categoryList![index].name!,page: page,
                    )),
                    child: Container(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          Padding(
                            padding: EdgeInsets.only(right: Dimensions.paddingSizeExtraSmall ,left:Dimensions.paddingSizeExtraSmall ),
                            child: Text(
...
class CategoryViewSections extends StatelessWidget {
  const CategoryViewSections({Key? key}) : super(key: key);
            ...
            categoryController.categoryList != null ? GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeSmall, top: Dimensions.paddingSizeDefault,left: Dimensions.paddingSizeSmall,),
                  child: InkWell(
                    onTap: () => Get.toNamed(RouteHelper.getCategoryItemRouteSections(
